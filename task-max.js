...
let userMoneyU = prompt(`Введіть необхідну суму USD, яку ви хочете обміняти:`);
let userMoneyE = userMoneyU * EUR;
alert(`Ваша сума до отримання: ${userMoneyE.toFixed(2)} EUR`);